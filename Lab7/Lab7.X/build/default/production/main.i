...
__attribute__((inline)) void SetBitHigh(uchar* byValue, uchar byBitOffset)
{
    *byValue |= (1U << byBitOffset);
}

__attribute__((inline)) void SetBitLow(uchar* byValue, uchar byBitOffset)
{
    *byValue &= ~(1U << byBitOffset);
}

__attribute__((inline)) void SetBit(uchar* byValue, uchar byBitOffset, uchar byBitValue)
{
    if (byBitValue > 0)
...
__attribute__((inline)) void ClearLowNibble(uchar* val)
{
    *val = *val & 0xF0;
}

__attribute__((inline)) void ClearHighNibble(uchar* val)
{
    *val = *val & 0x0F;
}

__attribute__((inline)) uchar GetLowNibble(uchar* val)
{
    return *val & 0xF0;
}

__attribute__((inline)) uchar GetHighNibble(uchar* val)
{
    return (*val & 0xF0) >> 4;
}
